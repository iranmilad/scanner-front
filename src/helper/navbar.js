...
export const headers = [
  ...
  },
  {
    name: 'نمودارها',
    link: '#',
    icon: <svg className='w-3.5 h-3.5 fill-gray-600 ml-3 group-hover:fill-blue-500' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><defs><style>{`.fa-secondary{opacity:.4}`}</style></defs><path class="fa-primary" d="M304 32C312.8 32 320 39.16 320 48V96C337.7 96 352 110.3 352 128V224C352 241.7 337.7 256 320 256V304C320 312.8 312.8 320 304 320C295.2 320 288 312.8 288 304V256C270.3 256 256 241.7 256 224V128C256 110.3 270.3 96 288 96V48C288 39.16 295.2 32 304 32zM416 144C416 135.2 423.2 128 432 128C440.8 128 448 135.2 448 144V192C465.7 192 480 206.3 480 224V288C480 305.7 465.7 320 448 320V368C448 376.8 440.8 384 432 384C423.2 384 416 376.8 416 368V320C398.3 320 384 305.7 384 288V224C384 206.3 398.3 192 416 192V144zM128 160C128 142.3 142.3 128 160 128V80C160 71.16 167.2 64 176 64C184.8 64 192 71.16 192 80V128C209.7 128 224 142.3 224 160V288C224 305.7 209.7 320 192 320V368C192 376.8 184.8 384 176 384C167.2 384 160 376.8 160 368V320C142.3 320 128 305.7 128 288V160z"/><path class="fa-secondary" d="M32 32C49.67 32 64 46.33 64 64V400C64 408.8 71.16 416 80 416H480C497.7 416 512 430.3 512 448C512 465.7 497.7 480 480 480H80C35.82 480 0 444.2 0 400V64C0 46.33 14.33 32 32 32z"/></svg>,
    children: [
      {
        name: 'عملکرد شرکت ها',
        link: '/reports',
